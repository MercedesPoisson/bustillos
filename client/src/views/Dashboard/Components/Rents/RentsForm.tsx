...
const RentsForm = () => {
    ...
    const handlePostRent = async () => {
        ...
        newForm.append("start_date", formData.start_date.toString());
        newForm.append("end_date", formData.end_date.toString());
        ...
        newForm.append("balance_exchange_rate", formData.balance_exchange_rate.toString());
